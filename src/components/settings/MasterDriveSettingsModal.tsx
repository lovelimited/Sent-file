            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <h3 className="text-sm sm:text-base font-bold text-slate-900">ตั้งค่า Master Google Drive รวม</h3>
                ...
                <p className="text-[11px] sm:text-xs text-slate-500">โฟลเดอร์ส่วนกลางสำหรับจัดเก็บไฟล์และทรัพยากรโรงเรียน</p>
              </div>
            </div>
            <button
              type="button"
              ...
              <div>
                ...
                {isLoading ? (
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs sm:text-sm text-slate-900 focus:bg-white focus:border-emerald-600 focus:outline-none focus:ring-1 focus:ring-emerald-600 transition-all"
                  />
                )}
